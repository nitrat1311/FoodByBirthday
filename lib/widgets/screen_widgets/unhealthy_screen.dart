...
class UnhealthyScreenWidget extends StatelessWidget {
  const UnhealthyScreenWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final model = unhealthyFoodList;

    return Scaffold(
      bottomNavigationBar: const Card(
          color: ColorAssets.bottomBarMinusColor,
          margin: EdgeInsets.only(bottom: 8),
          child: ListTile(
            title: (Links(
              text: TextAssests.instagramLink,
              style: TextStyle(
                  color: ColorAssets.linkTextMinusColor,
                  fontSize: 18,
      ...
      appBar: AppBar(
          ...
          title: const Text(TextAssests.unhealthyScreenAppBarText)),
